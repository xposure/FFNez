...
namespace Nez
{
    ...
    public struct decmat4 : IReadOnlyList<decimal>, IEquatable<decmat4>
    {
        ...
        /// </summary>
        public static decvec2 operator*(decmat4 m, decvec2 v) => new decvec2(((m.m00 * v.x + m.m10 * v.y) + m.m30), ((m.m01 * v.x + m.m11 * v.y) + m.m31));
        
        /// <summary>
        /// Executes a matrix-vector-multiplication.
        /// </summary>
        public static decvec3 operator*(decmat4 m, decvec3 v) => new decvec3(((m.m00 * v.x + m.m10 * v.y) + (m.m20 * v.z + m.m30)), ((m.m01 * v.x + m.m11 * v.y) + (m.m21 * v.z + m.m31)), ((m.m02 * v.x + m.m12 * v.y) + (m.m22 * v.z + m.m32)));
