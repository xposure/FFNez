...
namespace Nez
{
    ...
    public struct cmat4 : IReadOnlyList<Complex>, IEquatable<cmat4>
    {
        ...
        /// </summary>
        public static cvec2 operator*(cmat4 m, cvec2 v) => new cvec2(((m.m00 * v.x + m.m10 * v.y) + m.m30), ((m.m01 * v.x + m.m11 * v.y) + m.m31));
        
        /// <summary>
        /// Executes a matrix-vector-multiplication.
        /// </summary>
        public static cvec3 operator*(cmat4 m, cvec3 v) => new cvec3(((m.m00 * v.x + m.m10 * v.y) + (m.m20 * v.z + m.m30)), ((m.m01 * v.x + m.m11 * v.y) + (m.m21 * v.z + m.m31)), ((m.m02 * v.x + m.m12 * v.y) + (m.m22 * v.z + m.m32)));
