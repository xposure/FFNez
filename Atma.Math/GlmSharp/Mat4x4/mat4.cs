...
namespace Nez
{
    ...
    public struct mat4 : IReadOnlyList<float>, IEquatable<mat4>
    {
        ...
        //public static implicit operator Microsoft.Xna.Framework.Matrix(mat4 m) => new Microsoft.Xna.Framework.Matrix(m.Column0, m.Column1, m.Column2, m.Column3);
        public static implicit operator mat4(Microsoft.Xna.Framework.Matrix m) => new mat4(m.M11, m.M12, m.M13, m.M14,
                                                                                            m.M21, m.M22, m.M23, m.M24,
                                                                                            m.M31, m.M32, m.M33, m.M34,
                                                                                            m.M41, m.M42, m.M43, m.M44);

        public static implicit operator Microsoft.Xna.Framework.Matrix(mat4 m) => new Microsoft.Xna.Framework.Matrix(m.M11, m.M12, m.M13, m.M14,
                                                                                            m.M21, m.M22, m.M23, m.M24,
                                                                                            m.M31, m.M32, m.M33, m.M34,
                                                                                            m.M41, m.M42, m.M43, m.M44);

        //public static implicit operator Microsoft.Xna.Framework.Matrix(mat4 m) => new Microsoft.Xna.Framework.Matrix(m.M11, m.M21, m.M31, m.M41,
        //                                                                                    m.M12, m.M22, m.M32, m.M42,
        //                                                                                    m.M13, m.M23, m.M33, m.M43,
        //                                                                                    m.M14, m.M24, m.M34, m.M44);
        //public static implicit operator mat4(Microsoft.Xna.Framework.Matrix m) => new mat4(m.M11, m.M21, m.M31, m.M41,
        //                                                                                    m.M12, m.M22, m.M32, m.M42,
        //                                                                                    m.M13, m.M23, m.M33, m.M43,
        //                                                                                    m.M14, m.M24, m.M34, m.M44);

        public mat4 RowMajor => new mat4(Row0, Row1, Row2, Row3);

        public static mat4 CreateTranslation(float x, float y, float z) => Translate(x, y, z);
        public static mat4 CreateScale(float s) => Scale(s);
        public static mat4 CreateScale(float x, float y, float z) => Scale(x, y, z);

        private static mat4 InternalMultiply(mat4 lhs, mat4 rhs) => new mat4(((lhs.m00 * rhs.m00 + lhs.m10 * rhs.m01) + (lhs.m20 * rhs.m02 + lhs.m30 * rhs.m03)), ((lhs.m01 * rhs.m00 + lhs.m11 * rhs.m01) + (lhs.m21 * rhs.m02 + lhs.m31 * rhs.m03)), ((lhs.m02 * rhs.m00 + lhs.m12 * rhs.m01) + (lhs.m22 * rhs.m02 + lhs.m32 * rhs.m03)), ((lhs.m03 * rhs.m00 + lhs.m13 * rhs.m01) + (lhs.m23 * rhs.m02 + lhs.m33 * rhs.m03)), ((lhs.m00 * rhs.m10 + lhs.m10 * rhs.m11) + (lhs.m20 * rhs.m12 + lhs.m30 * rhs.m13)), ((lhs.m01 * rhs.m10 + lhs.m11 * rhs.m11) + (lhs.m21 * rhs.m12 + lhs.m31 * rhs.m13)), ((lhs.m02 * rhs.m10 + lhs.m12 * rhs.m11) + (lhs.m22 * rhs.m12 + lhs.m32 * rhs.m13)), ((lhs.m03 * rhs.m10 + lhs.m13 * rhs.m11) + (lhs.m23 * rhs.m12 + lhs.m33 * rhs.m13)), ((lhs.m00 * rhs.m20 + lhs.m10 * rhs.m21) + (lhs.m20 * rhs.m22 + lhs.m30 * rhs.m23)), ((lhs.m01 * rhs.m20 + lhs.m11 * rhs.m21) + (lhs.m21 * rhs.m22 + lhs.m31 * rhs.m23)), ((lhs.m02 * rhs.m20 + lhs.m12 * rhs.m21) + (lhs.m22 * rhs.m22 + lhs.m32 * rhs.m23)), ((lhs.m03 * rhs.m20 + lhs.m13 * rhs.m21) + (lhs.m23 * rhs.m22 + lhs.m33 * rhs.m23)), ((lhs.m00 * rhs.m30 + lhs.m10 * rhs.m31) + (lhs.m20 * rhs.m32 + lhs.m30 * rhs.m33)), ((lhs.m01 * rhs.m30 + lhs.m11 * rhs.m31) + (lhs.m21 * rhs.m32 + lhs.m31 * rhs.m33)), ((lhs.m02 * rhs.m30 + lhs.m12 * rhs.m31) + (lhs.m22 * rhs.m32 + lhs.m32 * rhs.m33)), ((lhs.m03 * rhs.m30 + lhs.m13 * rhs.m31) + (lhs.m23 * rhs.m32 + lhs.m33 * rhs.m33)));
        //public static mat4 Multiply(mat4 lhs, mat4 rhs) => rhs * lhs;
        public static mat4 Multiply(mat4 lhs, mat4 rhs) => InternalMultiply(rhs, lhs);// rhs * lhs;
        public static void Multiply(ref mat4 lhs, ref mat4 rhs, out mat4 result) => result = InternalMultiply(rhs, lhs);// rhs * lhs;
        public static mat4 CreateOrthographicOffCenter(float left, float right, float bottom, float top, float near, float far) => Ortho2(left, right, bottom, top, near, far);
        ...
        public float M43 { get => m32; set => m32 = value; }
        public float M44 { get => m33; set => m33 = value; }

        //public float M11 { get => m00; set => m00 = value; }
        //public float M12 { get => m10; set => m10 = value; }
        //public float M13 { get => m20; set => m20 = value; }
        //public float M14 { get => m30; set => m30 = value; }

        //public float M21 { get => m01; set => m01 = value; }
        //public float M22 { get => m11; set => m11 = value; }
        //public float M23 { get => m21; set => m21 = value; }
        //public float M24 { get => m31; set => m31 = value; }

        //public float M31 { get => m02; set => m02 = value; }
        //public float M32 { get => m12; set => m12 = value; }
        //public float M33 { get => m22; set => m22 = value; }
        //public float M34 { get => m32; set => m32 = value; }

        //public float M41 { get => m03; set => m03 = value; }
        //public float M42 { get => m13; set => m13 = value; }
        //public float M43 { get => m33; set => m23 = value; }
        //public float M44 { get => m33; set => m33 = value; }
        ...
        public override string ToString()
        {
            ...
            //"( ", this.m00.ToString(), "  ", this.m10.ToString(), "  ", this.m20.ToString(), "  ", this.m30.ToString(), " ) ",
            //"( ", this.m01.ToString(), "  ", this.m11.ToString(), "  ", this.m21.ToString(), "  ", this.m31.ToString(), " ) ",
            //"( ", this.m02.ToString(), "  ", this.m12.ToString(), "  ", this.m22.ToString(), "  ", this.m32.ToString(), " ) ",
            //"( ", this.m03.ToString(), "  ", this.m13.ToString(), "  ", this.m23.ToString(), "  ", this.m33.ToString(), " )");
        ...
        /// </summary>
        //TODO: public static mat4 operator *(mat4 lhs, mat4 rhs) => new mat4(((lhs.m00 * rhs.m00 + lhs.m10 * rhs.m01) + (lhs.m20 * rhs.m02 + lhs.m30 * rhs.m03)), ((lhs.m01 * rhs.m00 + lhs.m11 * rhs.m01) + (lhs.m21 * rhs.m02 + lhs.m31 * rhs.m03)), ((lhs.m02 * rhs.m00 + lhs.m12 * rhs.m01) + (lhs.m22 * rhs.m02 + lhs.m32 * rhs.m03)), ((lhs.m03 * rhs.m00 + lhs.m13 * rhs.m01) + (lhs.m23 * rhs.m02 + lhs.m33 * rhs.m03)), ((lhs.m00 * rhs.m10 + lhs.m10 * rhs.m11) + (lhs.m20 * rhs.m12 + lhs.m30 * rhs.m13)), ((lhs.m01 * rhs.m10 + lhs.m11 * rhs.m11) + (lhs.m21 * rhs.m12 + lhs.m31 * rhs.m13)), ((lhs.m02 * rhs.m10 + lhs.m12 * rhs.m11) + (lhs.m22 * rhs.m12 + lhs.m32 * rhs.m13)), ((lhs.m03 * rhs.m10 + lhs.m13 * rhs.m11) + (lhs.m23 * rhs.m12 + lhs.m33 * rhs.m13)), ((lhs.m00 * rhs.m20 + lhs.m10 * rhs.m21) + (lhs.m20 * rhs.m22 + lhs.m30 * rhs.m23)), ((lhs.m01 * rhs.m20 + lhs.m11 * rhs.m21) + (lhs.m21 * rhs.m22 + lhs.m31 * rhs.m23)), ((lhs.m02 * rhs.m20 + lhs.m12 * rhs.m21) + (lhs.m22 * rhs.m22 + lhs.m32 * rhs.m23)), ((lhs.m03 * rhs.m20 + lhs.m13 * rhs.m21) + (lhs.m23 * rhs.m22 + lhs.m33 * rhs.m23)), ((lhs.m00 * rhs.m30 + lhs.m10 * rhs.m31) + (lhs.m20 * rhs.m32 + lhs.m30 * rhs.m33)), ((lhs.m01 * rhs.m30 + lhs.m11 * rhs.m31) + (lhs.m21 * rhs.m32 + lhs.m31 * rhs.m33)), ((lhs.m02 * rhs.m30 + lhs.m12 * rhs.m31) + (lhs.m22 * rhs.m32 + lhs.m32 * rhs.m33)), ((lhs.m03 * rhs.m30 + lhs.m13 * rhs.m31) + (lhs.m23 * rhs.m32 + lhs.m33 * rhs.m33)));
        ...
        /// </summary>
        //TODO: public static mat4 operator /(mat4 A, mat4 B) =>  A * B.Inverse;
        ...
        public static mat4 Ortho2(float left, float right, float bottom, float top, float zNear, float zFar)
        {
            var m = Identity;
            m.m00 = 2 / (right - left);
            m.m11 = 2 / (top - bottom);
        ...
        public static vec3 UnProjectFaster(vec3 win, mat4 model, mat4 proj, vec4 viewport)
        {
            ...
            //TODO: var obj = (proj * model).Inverse * tmp;
            var obj = Multiply(model, proj).Inverse * tmp;
            return (vec3)obj / obj.w;
        }
        ...
        public static mat4 Lerp(mat4 lhs, mat4 rhs, float amount) => new mat4(vec4.Lerp(lhs.Column0, rhs.Column0, amount), vec4.Lerp(lhs.Column1, rhs.Column1, amount), vec4.Lerp(lhs.Column2, rhs.Column2, amount), vec4.Lerp(lhs.Column3, rhs.Column3, amount));
    }
}
