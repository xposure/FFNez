...
namespace Nez
{
    ...
    public struct lmat4 : IReadOnlyList<long>, IEquatable<lmat4>
    {
        ...
        /// </summary>
        public static lvec2 operator*(lmat4 m, lvec2 v) => new lvec2(((m.m00 * v.x + m.m10 * v.y) + m.m30), ((m.m01 * v.x + m.m11 * v.y) + m.m31));
        
        /// <summary>
        /// Executes a matrix-vector-multiplication.
        /// </summary>
        public static lvec3 operator*(lmat4 m, lvec3 v) => new lvec3(((m.m00 * v.x + m.m10 * v.y) + (m.m20 * v.z + m.m30)), ((m.m01 * v.x + m.m11 * v.y) + (m.m21 * v.z + m.m31)), ((m.m02 * v.x + m.m12 * v.y) + (m.m22 * v.z + m.m32)));
