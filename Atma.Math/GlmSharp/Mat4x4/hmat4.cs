...
namespace Nez
{
    ...
    public struct hmat4 : IReadOnlyList<Half>, IEquatable<hmat4>
    {
        ...
        /// </summary>
        public static hvec2 operator*(hmat4 m, hvec2 v) => new hvec2(((m.m00 * v.x + m.m10 * v.y) + m.m30), ((m.m01 * v.x + m.m11 * v.y) + m.m31));
        
        /// <summary>
        /// Executes a matrix-vector-multiplication.
        /// </summary>
        public static hvec3 operator*(hmat4 m, hvec3 v) => new hvec3(((m.m00 * v.x + m.m10 * v.y) + (m.m20 * v.z + m.m30)), ((m.m01 * v.x + m.m11 * v.y) + (m.m21 * v.z + m.m31)), ((m.m02 * v.x + m.m12 * v.y) + (m.m22 * v.z + m.m32)));
