...
namespace Nez
{
    ...
    public struct umat4 : IReadOnlyList<uint>, IEquatable<umat4>
    {
        ...
        /// </summary>
        public static uvec2 operator*(umat4 m, uvec2 v) => new uvec2(((m.m00 * v.x + m.m10 * v.y) + m.m30), ((m.m01 * v.x + m.m11 * v.y) + m.m31));
        
        /// <summary>
        /// Executes a matrix-vector-multiplication.
        /// </summary>
        public static uvec3 operator*(umat4 m, uvec3 v) => new uvec3(((m.m00 * v.x + m.m10 * v.y) + (m.m20 * v.z + m.m30)), ((m.m01 * v.x + m.m11 * v.y) + (m.m21 * v.z + m.m31)), ((m.m02 * v.x + m.m12 * v.y) + (m.m22 * v.z + m.m32)));
