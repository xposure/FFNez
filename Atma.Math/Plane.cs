...
namespace Atma
{
    ...
    public struct Plane
    {
        ...
        public Plane(vec3 point0, vec3 point1, vec3 point2)
        {
            ...
            this.Normal = vec3.Cross(edge1, edge2).Normalized;
        ...
        /// <returns></returns>
        public PlaneSide GetSide(vec3 point)
        {
        ...
        /// </returns>
        public PlaneSide GetSide(vec3 centre, vec3 halfSize)
        {
            ...
            float maxAbsDist = glm.Abs(vec3.Dot(this.Normal, halfSize));
        ...
        {
            return  vec3.Dot(Normal, point) + this.D;
        }
        ...
        public void Redefine(vec3 rkNormal, vec3 rkPoint)
        {
            this.Normal = rkNormal;
            this.D = -vec3.Dot(rkNormal, rkPoint);
        }
        ...
        /// <param name="point1">Second point.</param>
        /// <param name="point2">Third point.</param>
        public void Redefine(vec3 point0, vec3 point1, vec3 point2)
        {
            vec3 edge1 = point1 - point0;
            vec3 edge2 = point2 - point0;
            this.Normal = vec3.Cross(edge1, edge2).Normalized;
            //this.Normal.Normalized;
            this.D = -vec3.Dot(Normal, point0);
        }
        ...
        /// <param name="v"></param>
        /// <returns></returns>
        public vec3 ProjectVector(vec3 point)
        {
