...
namespace Nez.Common.Decomposition
{
    ...
    {
        private static vec2 _tmpA;
        private static vec2 _tmpB;
        private static vec2 _tmpC;
        ...
        private static bool InsideTriangle(ref vec2 a, ref vec2 b, ref vec2 c, ref vec2 p)
        {
            //A cross bp
