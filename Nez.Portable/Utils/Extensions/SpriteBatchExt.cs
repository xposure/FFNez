...
namespace Nez
{
	public static class SpriteBatchExt
	{
		...
		public static void drawLine( this SpriteBatch spriteBatch, vec2 start, vec2 end, Color color )
		{
			drawLineAngle( spriteBatch, start, Mathf.angleBetweenVectors( start, end ), vec2.Distance( start, end ), color );
		}


		public static void drawLine( this SpriteBatch spriteBatch, vec2 start, vec2 end, Color color, float thickness )
		{
			drawLineAngle( spriteBatch, start, Mathf.angleBetweenVectors( start, end ), vec2.Distance( start, end ), color, thickness );
		}


		public static void drawLine( this SpriteBatch spriteBatch, float x1, float y1, float x2, float y2, Color color )
		{
			drawLine( spriteBatch, new vec2( x1, y1 ), new vec2( x2, y2 ), color );
		}
		...
		public static void drawPoints( this SpriteBatch spriteBatch, List<vec2> points, Color color, float thickness = 1 )
		{
			if( points.Count < 2 )
				return;
		...
		/// <param name="color">The color to use</param>
		/// <param name="thickness">The thickness of the lines</param>
		public static void drawPoints( this SpriteBatch spriteBatch, vec2[] points, Color color, float thickness = 1 )
		{
			if( points.Length < 2 )
				return;
		...
		public static void drawPoints( this SpriteBatch spriteBatch, vec2 position, vec2[] points, Color color, bool closePoly = true, float thickness = 1 )
		{
			if( points.Length < 2 )
				return;
		...
		public static void drawPolygon( this SpriteBatch spriteBatch, vec2 position, vec2[] points, Color color, bool closePoly = true, float thickness = 1 )
		{
			if( points.Length < 2 )
				return;
		...
		public static void drawLineAngle( this SpriteBatch spriteBatch, vec2 start, float angle, float length, Color color )
		{
			spriteBatch.Draw( Graphics.instance.pixelTexture, start, Graphics.instance.pixelTexture.sourceRect, color, angle, vec2.Zero, new vec2( length, 1 ), SpriteEffects.None, 0 );
		}


		public static void drawLineAngle( this SpriteBatch spriteBatch, vec2 start, float angle, float length, Color color, float thickness )
		{
			spriteBatch.Draw( Graphics.instance.pixelTexture, start, Graphics.instance.pixelTexture.sourceRect, color, angle, new vec2( 0f, 0.5f ), new vec2( length, thickness ), SpriteEffects.None, 0 );
		}
		...
		{
			drawLineAngle( spriteBatch, new vec2( startX, startY ), angle, length, color );
		}
		...
		public static void drawCircle( this SpriteBatch spriteBatch, vec2 position, float radius, Color color, float thickness = 1f, int resolution = 12 )
		{
		...
		{
			drawCircle( spriteBatch, new vec2( x, y ), radius, color, resolution );
		}
		...
		public static void drawRect( this SpriteBatch spriteBatch, vec2 position, float width, float height, Color color )
		{
		...
		public static void drawHollowRect( this SpriteBatch spriteBatch, vec2 position, float width, float height, Color color )
		{
		...
		{
			drawPixel( spriteBatch, new vec2( x, y ), color );
		}


		public static void drawPixel( this SpriteBatch spriteBatch, vec2 position, Color color, int size = 1 )
		{
